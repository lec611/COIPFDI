...
<div class="login layui-anim layui-anim-up">
    <div class="message">OICPFDI - 注册</div>
    <div id="darkbannerwrap"></div>
    <form class="layui-form" action="" method="post">
        <input type="text" name="username" id="username" lay-verify="required|username" placeholder="请输入用户名(必填)" 
               autocomplete="off" class="layui-input">
        <hr class="hr15">
        <input type="text" name="email" id="email" lay-verify="required|email" placeholder="请输入邮箱(必填)" 
               autocomplete="off" class="layui-input">
        <hr class="hr15">
        <input type="password" name="password" id="password" lay-verify="required|password" placeholder="请输入密码(必填)" 
               autocomplete="off" class="layui-input">
        <hr class="hr15">
        <input type="password" name="rePassword" id="rePassword" lay-verify="required|rePassword" placeholder="请确认密码(必填)" 
               autocomplete="off" class="layui-input">
        <hr class="hr15">
        ...
        <div class="layui-form-item">
            <div class="layui-input-inline">
                <input type="text" name="emailCaptcha" id="emailCaptcha" lay-verify="required|emailCaptcha"  placeholder="请输入邮箱验证码(必填)" required="true"
                       autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-inline">
                <p style="text-align: left"><a href="${ctx}/login.jsp">已有账号？前往登录</a></p>
            </div>
        </div>
